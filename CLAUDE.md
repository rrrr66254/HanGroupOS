...
새로운 기능 구현이 완료될 때마다 **반드시 아래 세 가지를 순서대로 수행**하세요.
...
매 작업 완료 시 변경 내용을 `README.md`에 반영합니다. 새로운 기능, API, 설정 변경 등을 해당 섹션에 추가하거나 업데이트합니다.

### 3. 다음 추천 5가지

Push 완료 메시지 바로 다음에 **반드시** 아래 형식으로 추천 5가지를 출력합니다:
